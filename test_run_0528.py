...
parser.add_argument('--save', type=str, default='tests/', metavar='F',
...
# customized save directory by Yizhi
custom_dir = args.save
save_dir = 'img_results/' + custom_dir
if not os.path.exists(save_dir): os.mkdir(save_dir)
# save output modified by zz
# plt.savefig('./img_results/test_for_milestone/result.png')
# 20 epochs trial by Yizhi
